...
class AipImageClassify(AipBase):
    ...
    __logoSearchUrl = 'https://aip.baidubce.com/rest/2.0/image-classify/v2/logo识别'

    __logoAddUrl = 'https://aip.baidubce.com/rest/2.0/realtime_search/v1/logo识别/add'

    __logoDeleteUrl = 'https://aip.baidubce.com/rest/2.0/realtime_search/v1/logo识别/delete'
